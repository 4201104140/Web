    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CategoryId = table.Column<string>(maxLength: 6, nullable: false),
                    CategoryName = table.Column<string>(maxLength: 250, nullable: false),
                    CategoryRemark = table.Column<string>(maxLength: 250, nullable: true),
                    CategoryIcon = table.Column<string>(maxLength: 20, nullable: true),
                    CategoryParentId = table.Column<string>(maxLength: 6, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<string>(maxLength: 6, nullable: true)
                },
                constraints: table =>
                {
